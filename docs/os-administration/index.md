...
???+ info "17 вопросов"
    ...
    12. Программы для автоматического обновления стороннего ПО
    13. [Антивирусные программы](exam/windows/13/)
    14. Программы для резервного копирования
    15. Мониторинг событий и аудит
    16. Программы для тестирования аппаратных узлов компьютера
