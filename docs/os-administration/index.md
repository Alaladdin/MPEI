...
???+ info "15 вопросов"
    1. [Основные версии ОС `Apple macOS`](exam/macos/1/)
    2. [Процесс ручной установки ОС `Apple macOS`](exam/macos/2/)
    3. [Действия с учетными записями пользователей в ОС `Apple macOS`](exam/macos/3/)
